...
def show_venue(venue_id):
    ...
    past_shows = Show.query.filter_by(venue_id=venue_id).filter(Show.date < datetime.now())
    past_shows_count = past_shows.count()
    upcoming_shows = Show.query.filter_by(venue_id=venue_id).filter(Show.date > datetime.now())
    upcoming_shows_count = upcoming_shows.count()
    return render_template('pages/show_venue.html', venue=data,
    upcoming_shows=upcoming_shows, past_shows=past_shows, past_count=past_shows_count, upcoming_count=upcoming_shows_count)
...
def show_artist(artist_id):
    ...
    past_shows = Show.query.filter_by(artist_id=artist_id).filter(Show.date < datetime.now())
    past_shows_count = past_shows.count()
    upcoming_shows = Show.query.filter_by(artist_id=artist_id).filter(Show.date > datetime.now())
    upcoming_shows_count = upcoming_shows.count()
